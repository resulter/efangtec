...
import com.efangtec.common.mybatis.parser.AbstractJsqlParser;
...
public class TenantSqlParser extends AbstractJsqlParser {
    ...
    public void processUpdate(Update update) {
        ...
        Preconditions.checkArgument(null != tableList && tableList.size() < 2, "Failed to process multiple-table update, please exclude the statementId");
